  ...
  return (
    <main className="page container">
      ...
      <section className="product-detail">
        <div className="product-detail__gallery">{product.badge && <span className="badge">{product.badge}</span>}<ProductVisual icon={product.icon} accent={product.accent} large /><div className="gallery-note">{zh ? "概念产品图 · 演示目录" : "Concept product visual · Prototype catalogue"}</div></div>
